...
print(resultado)
resultado_1 = es_comienzo_linea(
    '7/11/20 10:02 - Los mensajes y las llamadas están cifrados de extremo a extremo. Nadie fuera de este chat, ni siquiera WhatsApp, puede leerlos ni escucharlos. Toca para obtener más información.')
print(resultado_1)
